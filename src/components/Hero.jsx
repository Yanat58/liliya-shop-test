...
const Hero = () => {
  return (
    <section id="about">
      <div className={`${styles.flexStart}  flex-1 flex flex-col-2  py-[30px]`}>
        <div className={`flex flex-1 relative pt-24 w-full`}>
          ...
          <div className='basis-2/5'>
            ...
            <h1 className={`${styles.title} text-[64px] text-black mb-[25px]`}>
              Осінь&#39;2023
            </h1>
            <button
              type="button"
